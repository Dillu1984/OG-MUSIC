...
async def init():
    ...
    LOGGER("OG_PLAYER").info("Og Player Bot Started Successfully")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("OG_PLAYER").info("Stopping Og Player Bot! GoodBye")
